...
const Vets = ({ vetData }) => {
    ...
    return (
        <div className="  mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 xl:max-w-[1700px] xl:ml-20 xl:mx-auto lg:max-w-[1100px] lg:mx-auto sm:max-w-[700px] sm:mx-auto  ">
                {
